dependencies {
    ...
    implementation("org.hibernate.orm:hibernate-community-dialects:6.6.20.Final")
    testImplementation("org.hibernate.orm:hibernate-community-dialects:6.6.20.Final")
